...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_desc" name="product_desc" required = "required" class="form-control" value="<?php echo $product_description ?>"> 
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_keywords" class="form-label">Product description</label>
            <input type="text" id="product_keywords" name="product_keywords" required = "required" class="form-control" value="<?php echo $product_keywords?>"> 
        </div>
        <div class="form-outline w-50 m-auto mb-4">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" required = "required" name="product_image2" class="form-control w-90 m-auto"> 
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image3" required = "required" name="product_image3" class="form-control w-90 m-auto"> 
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_price" required = "required" name="product_price" class="form-control" value="<?php echo $product_price ?>"> 
        </div>
