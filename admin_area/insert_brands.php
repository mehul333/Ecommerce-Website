...
<div class="input-group mb-2 w-10 " >
  <input type="submit" class="bg-info p-2 border-0 my-3" name="insert_brand" value="Insert brand" placeholder="Insert categories">
  <!-- <button class="bg-info p-2 m-2 border-0">Insert brands</button> -->
</div>
</form>